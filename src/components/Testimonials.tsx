...
const DEFAULT_TESTIMONIALS = [
  {
    ...
    rating: 5,
    date: '2 weeks ago',
    text: "Well maintained AC dining halls, delicious food and great staff. We stopped here on our way to Dooars and had a wonderful dinner.",
    tags: ['Good Staff', 'AC Dining', 'Highway Stop'],
    initials: 'AD',
    color: 'bg-orange-500',
  },
  {
